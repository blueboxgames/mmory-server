...
public class JoinSpectatorHandler extends BaseClientRequestHandler
{
    ...
    {
        CreateRoomSettings.RoomExtensionSettings res = new CreateRoomSettings.RoomExtensionSettings("MMOryExtension", "com.gerantech.towers.sfs.administration.SpectateRoom");
