...
public class OauthHandler extends BaseClientRequestHandler 
{
	public void handleClientRequest(User sender, ISFSObject params)
    {
		...
		try {
			...
			ISFSArray accounts = dbManager.executeQuery("SELECT type, player_id FROM accounts WHERE google_id='" + params.getText("accountId") + "'", new Object[] {});
			...
			if( needInsert )
				dbManager.executeInsert("INSERT INTO accounts (`player_id`, `type`, `google_id`, `name`, `image_url`) VALUES ('" + playerId + "', '" + params.getInt("accountType") + "', '" + params.getText("accountId") + "', '" + params.getText("accountName") + "', '" + params.getText("accountImageURL") + "');", new Object[] {});
